...
df1 <- read.csv("cache/GWAS_DATA/CobWidth_BLUP_2018_2019_withN_lme4.csv")
...
df2 <- read.csv("cache/GWAS_DATA/CobWidth_BLUP_2018_2019_noN_lme4.csv")
...
hist(df1$value, breaks=25, col="#6495ed", xlab="Cob width in +N in 2018-2019", ylab="freq", main="histogram")


hist(df2$value, breaks=25, col="#c6e2ff", xlab="Cob width in -N in 2018-2019", ylab="freq", main="histogram")
